...
Generated with the factory `factory-image` deployment on 2026-08-27. Original to this product; no third-party source material. Source PNG and prompt sidecar live in `assets/src/`; optimized WebP is shipped in the frontend. The 1200 × 630 social preview is a centered crop of that same original plate. The Apple touch icon is a hand-authored moss circle and graphite rule mark, made locally from the product palette.
